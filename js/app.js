...
const HELP = {
  "/": { t: "대시보드", b: `
<div class="help-lead">팀 전체 현황을 한 화면에서 확인합니다. 위에서부터 <b>주 달력 → 공지 → 현황 수치 → 미해결 이슈 → 근태 → 진행 중 과업</b> 순서입니다.</div>
<h4>① 주 달력</h4>
<ul>
<li><b>지난주·이번주·다음주</b> 3주만 표시되며, 토·일은 제외한 <b>월~금</b>만 나옵니다. 오늘 날짜는 강조 표시됩니다.</li>
<li><b>등록(팀장만)</b>: 날짜 칸을 클릭 → 모달에서 <b>제목</b> 입력 + <b>색상</b> 선택 → 저장.</li>
<li>색상 의미 — <b>일정(녹색) · 중요(빨강) · 세미나(주황) · 회의(파랑) · 기타(회색)</b>.</li>
<li><b>수정</b>: 등록된 일정 제목을 클릭하면 수정 모달이 열립니다. <b>삭제</b>: 일정 오른쪽 <code>✕</code>.</li>
<li>팀원은 열람만 가능합니다.</li>
</ul>
<h4>② 공지 · 팀 전달사항</h4>
<ul>
<li>회사 방침 등 <b>공지</b>와 팀 내 업무 <b>전달사항</b>이 함께 표시됩니다.</li>
<li><b>등록(팀장만)</b>: <code>+ 공지</code> 클릭 → 유형(공지/팀 전달사항) 선택 + 내용 입력 → 저장.</li>
<li>각 항목의 <code>수정</code> · <code>삭제</code> 버튼으로 변경할 수 있습니다(팀장).</li>
</ul>
<h4>③ 현황 수치</h4>
<ul><li>미해결 이슈 수, 진행 중 과업 수, 기한 경과 과업 수 등 핵심 지표입니다. 숫자를 눌러 해당 메뉴로 이동합니다.</li></ul>
<h4>④ 미해결 이슈</h4>
<ul><li>완료되지 않은 이슈 목록입니다. 안건을 클릭하면 <b>이슈 상세</b>로 이동합니다.</li></ul>
<h4>⑤ 근태</h4>
<ul><li>오늘 이후 예정된 연차·반차·시차·출장 등이 표시됩니다. 등록은 <b>근태</b> 메뉴에서 합니다.</li></ul>
<h4>⑥ 진행 중 과업</h4>
<ul><li>기본적으로 <b>접혀 있습니다</b>. 제목 줄을 클릭하면 펼쳐집니다. 기한이 지난 과업은 붉게 표시됩니다.</li></ul>
<h4>상단 표시</h4>
<ul><li>좌측 상단 <b>이름 동그라미</b>는 현재 접속 중인 팀원, <b>🔔</b>는 내게 온 알림입니다.</li></ul>` },

  "/tasks": { t: "WBS 진행 현황", b: `
<div class="help-lead">팀의 모든 과업(Task)을 등록하고 진행률을 관리하는 <b>핵심 메뉴</b>입니다.</div>
<h4>목록 보는 법</h4>
<ul>
<li>컬럼: <b>WBS/업무 · 담당 · 시급성 · Start · End(plan) · End(real) · 진행률</b>.</li>
<li><b>Start / End(plan)</b> = 계획 일정, <b>End(real)</b> = 실제 완료일.</li>
<li>진행률 막대가 100%면 완료, 기한이 지났는데 미완료면 <b>기한 경과</b>로 붉게 표시됩니다.</li>
<li>상단 <b>간트 차트</b>로 기간을 시각적으로 확인할 수 있습니다.</li>
</ul>
<h4>필터</h4>
<ul><li><b>담당자</b> 선택, <b>상태</b>(진행중 / 기한 경과 / Holding / 완료), <b>검색어</b>로 좁혀 볼 수 있습니다.</li></ul>
<h4>+ 과업 등록</h4>
<ul>
<li><b>WBS 메뉴(Lv3)</b> <span class="help-tip">필수</span> — 드롭다운에서 선택. 목록에 없으면 <code>+ WBS 등록 (팀장)</code>으로 먼저 만듭니다.</li>
<li><b>수행 업무(Lv5)</b> — 예: <code>파싱 로직</code></li>
<li><b>상세 업무 내용(Lv6)</b> <span class="help-tip">필수</span> — 실제로 무엇을 하는지 구체적으로.</li>
<li><b>담당자 / 시급성 / Start / End(plan) / 비고</b> 입력 후 저장.</li>
</ul>
<h4>수정 · 삭제</h4>
<ul>
<li>행 오른쪽 <code>수정</code> → <b>상세 업무 내용 · 시급성 · 진행률(%) · End(real) · 상태(Holding 등)</b>를 변경합니다.</li>
<li><span class="help-tip">진행률을 100%로 저장하려면 End(real)이 반드시 입력되어야 합니다.</span></li>
<li><b>팀장 코멘트</b> 칸은 팀장만 작성·수정할 수 있으며, 저장하면 담당자에게 <b>알림이 발송</b>됩니다.</li>
<li>수정·삭제는 <b>본인 과업</b> 또는 <b>팀장</b>만 가능합니다.</li>
</ul>` },

  "/wbs": { t: "전체 WBS 관리 (팀장)", b: `
<div class="help-lead">과업 등록 시 선택하는 <b>WBS 코드 체계</b>를 관리합니다. 등록·수정·삭제는 <b>팀장 전용</b>이며, 팀원은 열람만 가능합니다.</div>
<h4>목록</h4>
<ul>
<li>컬럼: <b>탭 · 소분류 · 코드 · 설명</b>.</li>
<li>상단 검색창에 <b>탭 / 소분류 / 코드 / 설명</b> 아무 키워드나 입력하면 즉시 필터링됩니다.</li>
</ul>
<h4>+ WBS 등록</h4>
<ul>
<li><b>탭(Lv1)</b> — 예: <code>1. 일일보고</code></li>
<li><b>소분류(Lv2)</b> — 예: <code>1.1 입력 및 보고</code></li>
<li><b>코드/메뉴(Lv3)</b> — 예: <code>1.1.5 신규 메뉴명</code></li>
<li><b>설명</b> 입력 후 저장하면, <b>WBS 진행 현황 → 과업 등록</b>의 드롭다운에 곧바로 반영됩니다.</li>
</ul>
<h4>수정 · 삭제</h4>
<ul><li>행 오른쪽 <code>수정</code> / <code>삭제</code>. 이미 과업이 연결된 WBS는 삭제 전 영향 여부를 확인하세요.</li></ul>` },

  "/issues": { t: "WBS별 이슈", b: `
<div class="help-lead">과업 수행 중 <b>팀장 판단이 필요한 사항</b>을 정식으로 질의하고 <b>GO(승인)</b>를 받는 절차입니다.</div>
<h4>목록</h4>
<ul>
<li>컬럼: <b>일자 · 안건 · 담당 · 요청(GO 단계) · 상태</b>. 행을 클릭하면 상세로 이동합니다.</li>
<li>필터: <b>전체 / 미해결 / 완료</b> + 검색어.</li>
</ul>
<h4>+ 이슈 등록 (작성 요령)</h4>
<ul>
<li><b>일자 · 담당자 · WBS 메뉴</b> — 예: <code>1.1.3 작업보고(기존)</code></li>
<li><b>안건 — 왜 논의가 필요한가</b> <span class="help-tip">필수</span> · <b>1문장, 120자 이내</b>로 압축해 작성.</li>
<li><b>질의 사항 / 요청사항</b> — <code>1. 질의</code> <code>2. 질의</code> 처럼 <b>번호를 매겨</b> 나열.</li>
<li><b>본인의 생각</b> — 각 질의에 <b>1:1로 대응</b>하게 <code>1. 의견(질의 1에 대한)</code> 형식으로. 질의만 던지지 말고 반드시 본인 안을 제시합니다.</li>
<li><b>참고 자료</b> — 드롭다운에서 <b>참고자료 메뉴에 등록된 구글 시트 등을 선택</b>하거나, 링크·자료명을 직접 입력합니다.</li>
</ul>
<h4>진행 절차 (상세 화면)</h4>
<ul>
<li><b>GO 제출</b> — 담당자가 작성을 마치면 <code>GO</code> 클릭. <span class="help-tip">제출 시 안건·질의·본인생각이 잠기며 더 이상 수정할 수 없습니다.</span> Slack 알림이 발송됩니다.</li>
<li><b>피드백</b> — 팀장이 답변을 입력합니다.</li>
<li><b>재질의(GO*2 · GO*3)</b> — 피드백으로 해결되지 않으면 <b>추가 질의 + 그에 대한 본인 의견</b>을 작성해 다시 제출합니다. 최대 3차까지 진행합니다.</li>
<li><b>완료 처리</b> — 해결되면 <code>완료</code> 클릭. 담당자에게 <b>알림이 발송</b>됩니다.</li>
<li><b>댓글</b> — 자유 논의용. <code>@멘션</code>을 선택하면 해당 인원에게 Slack 알림이 갑니다. 본인 댓글은 수정·삭제 가능.</li>
</ul>
<h4>권한</h4>
<ul><li>수정은 <b>본인 이슈</b> 또는 <b>팀장</b>만. <span class="help-tip">GO 제출 이후에는 잠긴 항목을 수정할 수 없습니다.</span></li></ul>` },

  "/weekly": { t: "주간 업무 요약", b: `
<div class="help-lead">한 주 단위로 <b>팀원별 업무 요약</b>을 한 표에 모아 봅니다.</div>
<h4>표 보는 법</h4>
<ul>
<li>행 = <b>주차</b>, 열 = <b>팀원</b>. <span class="help-tip">팀장은 작성 대상이 아니므로 강지영~이민지 5명의 컬럼만 생성됩니다.</span></li>
</ul>
<h4>+ 주차 추가</h4>
<ul><li>클릭하면 <b>오늘(한국 시각) 기준 해당 주의 월~금</b> 라벨로 새 주차 행이 만들어지고, 팀원 5명의 빈 칸이 함께 생성됩니다.</li></ul>
<h4>작성 · 수정</h4>
<ul>
<li>본인 이름의 칸을 <b>클릭</b>하면 입력 모달이 열립니다. 그 주에 한 일을 요약해 입력 후 저장.</li>
<li>본인 칸만 작성·수정할 수 있습니다(팀장은 전체 가능).</li>
</ul>
<h4>코멘트</h4>
<ul><li><code>+ 코멘트</code>로 팀장 코멘트를 남길 수 있고, 남긴 코멘트는 <code>수정</code> · <code>삭제</code>할 수 있습니다.</li></ul>` },

  "/daily": { t: "일일 기록 (ERP)", b: `
<div class="help-lead">Baron ERP <b>근태이력 상세</b>에서 수집한 일일 업무 기록을 날짜·팀원별로 보여줍니다.</div>
<h4>화면 보는 법</h4>
<ul>
<li>날짜별로 팀원 카드가 나열되고, 각 카드에 <b>프로젝트 · 서브코드 · 업무 내용 [시간]</b>이 표시됩니다.</li>
<li>기록이 많으면 <code>+ N건 더보기</code>로 펼칩니다.</li>
<li>대부분의 데이터는 <b>ERP 수집 북마클릿</b>으로 자동 업로드됩니다(하루 8시간 기준 자동 배분).</li>
</ul>
<h4>+ 기록 입력 (수동)</h4>
<ul>
<li><b>프로젝트</b> — 예: <code>[BD-26-활용-02] bCMf</code></li>
<li><b>서브코드</b> — 예: <code>e.S/W 설계</code></li>
<li><b>업무 내용</b> — <code>[시간] 업무 내용</code> 형식으로 입력합니다.</li>
</ul>
<h4>팀장 코멘트</h4>
<ul><li>카드의 <code>+ 팀장 코멘트</code>로 개별 기록에 코멘트를 달고, <code>수정</code> · <code>삭제</code>할 수 있습니다.</li></ul>` },

  "/deliverables": { t: "참고자료", b: `
<div class="help-lead">업무에 쓰이는 <b>구글 시트 등 외부 링크</b>를 모아 관리합니다. 여기 등록한 자료는 <b>WBS별 이슈의 '참고 자료' 필드에서 바로 선택</b>할 수 있습니다.</div>
<h4>목록</h4>
<ul>
<li>컬럼: <b>번호 · 설명 · URL · 담당 · 비고</b>. <b>가장 최근에 등록한 자료가 맨 위</b>에 옵니다.</li>
<li>URL을 클릭하면 새 창에서 열립니다.</li>
</ul>
<h4>+ 링크 추가</h4>
<ul>
<li><b>설명</b> <span class="help-tip">필수</span> — 무슨 자료인지 알아볼 수 있게.</li>
<li><b>URL</b> <span class="help-tip">필수</span> — 예: <code>https://docs.google.com/spreadsheets/...</code></li>
<li><b>비고</b> — 선택.</li>
</ul>
<h4>참고</h4>
<ul>
<li><span class="help-tip">파일 업로드 기능은 제공하지 않습니다.</span> <b>구글 시트 링크</b>만 등록해 주세요.</li>
<li>md · html 문서는 <b>HMCM Mock-up</b> 메뉴를 활용하시기 바랍니다.</li>
<li>수정 · 삭제는 <b>본인 등록분</b> 또는 <b>팀장</b>만 가능합니다.</li>
</ul>` },

  "/docs": { t: "HMCM Mock-up", b: `
<div class="help-lead">기존 HMCM Mock-up 사이트의 문서를 이 화면 안에서 조회합니다. md · html 산출물은 이곳에 둡니다.</div>
<h4>사용법</h4>
<ul>
<li><b>Enter your ID</b> 칸에 ID를 입력하고 열기를 누르면 Mock-up 사이트가 모달로 열립니다.</li>
<li>목록 컬럼: <b>문서명 · 크기 · 업로드일 · 보기</b>. <code>보기</code>를 누르면 문서 내용을 확인합니다.</li>
<li><code>삭제</code>는 본인 등록분 또는 팀장만 가능합니다.</li>
</ul>` },

  "/attendance": { t: "근태", b: `
<div class="help-lead">팀원의 연차·반차·시차·출장·<b>지각</b> 등을 집계합니다.</div>
<h4>월별 집계</h4>
<ul>
<li>행 = <b>팀원</b>, 열 = <b>근태 구분</b>, 마지막 열 = <b>합계</b>. 해당 월의 사용 현황을 한눈에 봅니다.</li>
</ul>
<h4>상세 기록</h4>
<ul>
<li>컬럼: <b>날짜 · 이름 · 구분 · 비고</b>. 구분은 색 배지로 표시됩니다(연차·출장·<b>지각(빨강)</b> 등).</li>
</ul>
<h4>+ 근태 등록</h4>
<ul>
<li><b>날짜 · 이름 · 구분</b>(연차 / 반차 / 시차 / 출장 / 연장근무 / 지각 / 기타) 선택.</li>
<li><b>비고</b> — 예: <code>8/18~21 (총 4일)</code> 처럼 기간이나 사유를 적습니다.</li>
</ul>
<h4>지각 자동 집계</h4>
<ul>
<li><b>지각</b>은 시차가 없는 평소 업무일에 <b>출근이 09:00을 넘긴 경우</b>이며, ERP 근태이력 상세에 <b>빨간색</b>으로 표기됩니다.</li>
<li>ERP 수집 북마클릿을 실행하면 지각이 <b>자동으로 수집·반영</b>되므로 수동 등록은 불필요합니다.</li>
<li>비고에는 실제 출근 시각(<code>출근 09:03</code>)이 자동 기록됩니다.</li>
</ul>
<h4>권한</h4>
<ul><li>수정 · 삭제는 <b>본인 기록</b> 또는 <b>팀장</b>만 가능합니다.</li></ul>` },

  "/suggest": { t: "건의사항", b: `
<div class="help-lead">업무 방식·환경 등에 대한 의견을 자유롭게 제안합니다.</div>
<h4>건의 작성</h4>
<ul><li>상단 입력창에 내용을 적고 등록하면 아래 <b>건의 목록</b>에 추가됩니다.</li></ul>
<h4>수정 · 삭제</h4>
<ul><li>각 건의의 <code>수정</code> · <code>삭제</code> 버튼으로 변경합니다. <b>본인 건의</b> 또는 <b>팀장</b>만 가능합니다.</li></ul>` },

  "/notes": { t: "운영 규칙", b: `
<div class="help-lead">팀 업무 수행의 기준이 되는 규칙을 모아 둔 곳입니다. 새로 합류했거나 절차가 헷갈릴 때 먼저 확인하세요.</div>
<h4>목록</h4>
<ul><li><b>규칙</b> 컬럼에 항목별 내용이 정리되어 있습니다.</li></ul>
<h4>등록 · 수정 · 삭제</h4>
<ul><li><code>+ 규칙 추가</code> 및 각 행의 <code>수정</code> · <code>삭제</code>는 <b>팀장 전용</b>입니다. 팀원은 열람만 가능합니다.</li></ul>` },
};

window.openHelp = function () {
  const hash = location.hash.replace(/^#/, "") || "/";
  let key = hash;
  if (hash === "/issues/new" || /^\/issues\/\d+$/.test(hash)) key = "/issues";
  const h = HELP[key] || HELP["/"];
  modal(`❓ 도움말 — ${h.t}`, `<div class="help-body">${h.b}</div>`, null);
};
